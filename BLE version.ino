...
void loop() {
    ...
    if (deviceConnected) {
        valuex = mpu.getQuaternionX ();
        valuey = mpu.getQuaternionY ();
        valuez = mpu.getQuaternionZ ();
        valuew = mpu.getQuaternionW ();
        ...
        data += String(valuew);
        Serial.println(data);
        data.toCharArray( dat, 200);
        pCharacteristic->setValue(dat);
